                    ...
                    <div className="flex items-center gap-2 flex-wrap pt-1">
                      {msg.evidence && (
                        <button
                          ...
                          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-teal-500/10 hover:bg-teal-500/20 text-xs text-teal-300 border border-teal-500/20 transition-colors font-medium"
                        >
