...
export function getSelectedLanguage(): string {
  ...
  try {
    ...
    if (stored) {
      const match = COASTAL_LANGUAGES.find(l => l.name.toLowerCase() === stored.toLowerCase() || l.code === stored.toLowerCase());
...
export function setSelectedLanguage(lang: LanguageVoiceConfig | string): void {
  ...
  try {
    ...
    const match = COASTAL_LANGUAGES.find(l => l.name.toLowerCase() === targetName.toLowerCase() || l.code === targetName.toLowerCase());
...
export const UI_TRANSLATIONS: Record<string, Record<string, string>> = {
  ...
  'JalSaathi Assistant': {
    Hindi: 'जलसाथी सहायक',
    Marathi: 'जलसाथी सहाय्यक',
    Gujarati: 'જલસાથી સહાયક',
    Tamil: 'ஜல்சாதி உதவியாளர்',
    Telugu: 'జల్సాథి సహాయకుడు',
    Kannada: 'ಜಲಸಾಥಿ ಸಹಾಯಕ',
    Malayalam: 'ജൽസാത്തി സഹായി',
    Bengali: 'জলসাথী সহকারী',
  },
  'Marine Map': {
    Hindi: 'समुद्री नक्शा',
    Marathi: 'सागरी नकाशा',
  ...
  'Active Alerts': {
    ...
    Malayalam: 'സജീവ മുന്നറിയിപ്പുകൾ',
    Bengali: 'সক্রিয় সতর্কতা',
  },
  'Ask JalSaathi': {
    Hindi: 'जलसाथी से पूछें',
    Marathi: 'जलसाथीला विचारा',
    Gujarati: 'જલસાથીને પૂછો',
    Tamil: 'ஜல்சாதியிடம் கேளுங்கள்',
    Telugu: 'జల్‌సాథీని అడగండి',
    Kannada: 'ಜಲಸಾಥಿಯನ್ನು ಕೇಳಿ',
    Malayalam: 'ജൽസാഥിയോട് ചോദിക്കൂ',
    Bengali: 'জলসাথীকে জিজ্ঞাসা করুন',
  },
  'Ask JalSaathi a question': {
    Hindi: 'जलसाथी से सवाल पूछें',
    Marathi: 'जलसाथीला प्रश्न विचारा',
    Gujarati: 'જલસાથીને પ્રશ્ન પૂછો',
    Tamil: 'ஜல்சாதியிடம் கேள்வி கேளுங்கள்',
    Telugu: 'జల్‌సాథీని ఒక ప్రశ్న అడగండి',
    Kannada: 'ಜಲಸಾಥಿಗೆ ಪ್ರಶ್ನೆ ಕೇಳಿ',
    Malayalam: 'ജൽസാഥിയോട് ചോദ്യം ചോദിക്കൂ',
    Bengali: 'জলসাথীকে একটি প্রশ্ন জিজ্ঞাসা করুন',
  },
  'View fishing zones': {
    Hindi: 'मत्स्य क्षेत्र देखें',
    Marathi: 'मासेमारी क्षेत्रे पहा',
    Gujarati: 'માછીમારી ઝોન જુઓ',
    Tamil: 'மீன்பிடி மண்டலங்களைப் பார்க்கவும்',
    Telugu: 'చేపల వేట ప్రాంతాలను చూడండి',
    Kannada: 'ಮೀನುಗಾರಿಕೆ ವಲಯಗಳನ್ನು ವೀಕ್ಷಿಸಿ',
    Malayalam: 'മത്സ്യബന്ധന മേഖലകൾ കാണുക',
    Bengali: 'মাছ ধরার অঞ্চল দেখুন',
  },
  'Plan a safe route': {
    Hindi: 'सुरक्षित मार्ग योजना बनाएं',
    Marathi: 'सुरक्षित मार्गाचे नियोजन करा',
    Gujarati: 'સલામત માર્ગનું આયોજન કરો',
    Tamil: 'பாதுகாப்பான பாதையைத் திட்டமிடுங்கள்',
    Telugu: 'సురక్షిత మార్గాన్ని ప్లాన్ చేయండి',
    Kannada: 'ಸುರಕ್ಷಿತ ಮಾರ್ಗವನ್ನು ಯೋಜಿಸಿ',
    Malayalam: 'സുരക്ഷിത പാത ആസൂത്രണം ചെയ്യുക',
    Bengali: 'নিরাপদ রুট পরিকল্পনা করুন',
  },
  'Open marine map': {
    Hindi: 'समुद्री नक्शा खोलें',
    Marathi: 'सागरी नकाशा उघडा',
    Gujarati: 'દરિયાઈ નકશો ખોલો',
    Tamil: 'கடல் வரைபடத்தைத் திறக்கவும்',
    Telugu: 'సముద్ర పటాన్ని తెరవండి',
    Kannada: 'ಸಾಗರ ನಕ್ಷೆಯನ್ನು ತೆರೆಯಿರಿ',
    Malayalam: 'സമുദ്ര ഭൂപടം തുറക്കുക',
    Bengali: 'সামুদ্রিক মানচিত্র খুলুন',
  },
  'View all': {
    Hindi: 'सभी देखें',
    Marathi: 'सर्व पहा',
