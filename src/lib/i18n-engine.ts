...
export const FULL_TRANSLATIONS: Record<string, Record<string, string>> = {
  ...
  'MAYDAY MAYDAY MAYDAY. Emergency distress signal transmitted for vessel INF 2847 Sagar Mitra near Coastal Waters. Indian Coast Guard alerted.': {
    Hindi: 'मेडे मेडे मेडे। तटीय जल क्षेत्र के पास पोत आईएनएफ 2847 सागर मित्र के लिए आपातकालीन संकट संकेत प्रसारित किया गया। भारतीय तटरक्षक बल को सतर्क कर दिया गया है।',
    Marathi: 'आणीबाणी मेडे आणीबाणी मेडे. किनारपट्टीजवळ जहाज आयएनएफ 2847 सागर मित्रसाठी आपत्कालीन संकट सिग्नल पाठवला गेला आहे. भारतीय तटरक्षक दलास सतर्क केले आहे.',
    Gujarati: 'મેડે મેડે મેડે. દરિયાકાંઠાના પાણી નજીક વહાણ INF 2847 સાગર મિત્ર માટે કટોકટી સંકેત પ્રસારિત થયો. ભારતીય કોસ્ટ ગાર્ડને ચેતવણી આપવામાં આવી છે.',
    Tamil: 'மேடே மேடே மேடே. கடலோரப் பகுதியில் ஐஎன்எஃப் 2847 சாகர் மித்ரா படகுக்கான அவசர ஆபத்து சமிக்கை அனுப்பப்பட்டது. இந்திய கடலோர காவல்படை எச்சரிக்கப்பட்டது.',
    Telugu: 'మేడే మేడే మేడే. తీరప్రాంతం సమీపంలో ఐఎన్‌ఎఫ్ 2847 సాగర్ మిత్ర పడవ కోసం అత్యవసర ప్రమాద సంకేతం ప్రసారం చేయబడింది. భారత కోస్ట్ గార్డ్ అప్రమత్తమైంది.',
    Kannada: 'ಮೇಡೇ ಮೇಡೇ ಮೇಡೇ. ಕರಾವಳಿ ನೀರಿನ ಬಳಿ ಐಎನ್‌ಎಫ್ 2847 ಸಾಗರ ಮಿತ್ರ ದೋಣಿಗೆ ತುರ್ತು ಸಂಕಷ್ಟದ ಸಂಕೇತವನ್ನು ರವಾನಿಸಲಾಗಿದೆ. ಭಾರತೀಯ ಕೋಸ್ಟ್ ಗಾರ್ಡ್ ಎಚ್ಚರಗೊಂಡಿದೆ.',
    Malayalam: 'മേഡേ മേഡേ മേഡേ. തീരദേശത്ത് ഐഎൻഎഫ് 2847 സാഗർ മിത്ര എന്ന യാനത്തിനായി അടിയന്തര ദുരിത സിഗ്നൽ അയച്ചു. ഇന്ത്യൻ കോസ്റ്റ് ഗാർഡിന് മുന്നറിയിപ്പ് നൽകി.',
    Bengali: 'মেডে মেডে মেডে। উপকূলীয় জলের কাছে আইএনএফ ২৮৪৭ সাগর মিত্র জাহাজের জন্য জরুরি বিপদ সংকেত পাঠানো হয়েছে। ভারতীয় কোস্ট গার্ডকে সতর্ক করা হয়েছে।',
  },
  'Mayday beacon active for Sagar Mitra near Coastal Waters. Hold fast, rescue dispatched.': {
    Hindi: 'सागर मित्र के लिए मेडे बीकन सक्रिय है। धैर्य रखें, बचाव दल रवाना कर दिया गया है।',
    Marathi: 'सागर मित्रसाठी मेडे बीकन सक्रिय आहे. शांत राहा, बचाव पथक रवाना झाले आहे.',
    Gujarati: 'સાગર મિત્ર માટે મેડે બીકન સક્રિય છે. શાંતિ રાખો, બચાવ ટીમ મોકલી દેવામાં આવી છે.',
    Tamil: 'சாகர் மித்ராவுக்கான மேடே பீக்கன் செயலில் உள்ளது. பொறுமையாக இருங்கள், மீட்பு குழு அனுப்பப்பட்டுள்ளது.',
    Telugu: 'సాగర్ మిత్ర కోసం మేడే బీకన్ యాక్టివ్‌గా ఉంది. ధైర్యంగా ఉండండి, సహాయక బృందం బయలుదేరింది.',
    Kannada: 'ಸಾಗರ ಮಿತ್ರಕ್ಕಾಗಿ ಮೇಡೇ ಬೀಕನ್ ಸಕ್ರಿಯವಾಗಿದೆ. ಸಮಾಧಾನವಾಗಿರಿ, ರಕ್ಷಣಾ ತಂಡವನ್ನು ಕಳುಹಿಸಲಾಗಿದೆ.',
    Malayalam: 'സാഗർ മിത്രയ്ക്കുള്ള മേഡേ ബീക്കൺ സജീവമാണ്. ശാന്തരായിരിക്കുക, രക്ഷാപ്രവർത്തകർ പുറപ്പെട്ടു.',
    Bengali: 'সাগর মিত্রের জন্য মেডে বীকন সক্রিয়। শান্ত থাকুন, উদ্ধারকারী দল পাঠানো হয়েছে।',
  },
};

export const LANGUAGE_ANNOUNCEMENTS: Record<string, string> = {
  English: 'Language changed to English.',
  Hindi: 'भाषा हिंदी में बदल दी गई है।',
  Marathi: 'भाषा मराठी मध्ये बदलली आहे.',
...
export const PHRASE_DICTIONARY: Record<string, Record<string, string>> = {
  Telugu: {
    ...
    'JalSaathi Assistant': 'జల్సాథి అసిస్టెంట్',
  ...
  Hindi: {
    ...
    'Dashboard': 'डैशबोर्ड',
    'JalSaathi Assistant': 'जलसाथी सहायक',
  ...
  Tamil: {
    ...
    'JalSaathi Assistant': 'ஜல்சாதி உதவியாளர்',
  ...
  Marathi: {
    ...
    'Dashboard': 'डॅशबोर्ड',
    'JalSaathi Assistant': 'जलसाथी सहाय्यक',
  ...
  Gujarati: {
    ...
    'Dashboard': 'ડેશબોર્ડ',
    'JalSaathi Assistant': 'જલસાથી સહાયક',
  ...
  Malayalam: {
    ...
    'JalSaathi Assistant': 'ജൽസാത്തി അസിസ്റ്റന്റ്',
  ...
  Kannada: {
    ...
    'JalSaathi Assistant': 'ಜಲಸಾಥಿ ಸಹಾಯಕ',
  ...
  Bengali: {
    ...
    'JalSaathi Assistant': 'জলসাথী সহকারী',
