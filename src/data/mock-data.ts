...
export function getMockFishingZones(): FishingZone[] {
  return [
    {
      id: 'zone-mumbai',
      name: 'Mumbai High-Yield Shelf PFZ',
  ...
  return [
    {
      ...
      risks: [
        { type: 'Vessel Traffic', severity: 'MEDIUM', description: 'Moderate traffic near shipping lane' },
      ],
    },
    {
      id: 'route-b',
      name: 'Route B — Coastal',
      waypoints: [
        { lat: 18.95, lon: 72.82 },
        { lat: 18.90, lon: 72.65 },
        { lat: 18.82, lon: 72.48 },
      ...
      isRecommended: true,
      reason: 'Lower wave exposure and reduced vessel traffic along the coastal shelf.',
    ...
    },
    {
      ...
      risks: [
        ...
        { type: 'Vessel Traffic', severity: 'MEDIUM', description: 'Crosses major shipping lane' },
      ],
    },
  ];
}
